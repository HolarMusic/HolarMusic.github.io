var trackList = (() => {
	...
	const trackList = new Map([
		...
		['nightOwls', {
			...
			download: {
				flac: Link.googleDrive(`0B-nGL81MTHrceDdYUWxHMlZrbzA`),
				mp3: Link.googleDrive(`0B-nGL81MTHrcN0dCOS1nN0hRRmc`)
			},
			details: {
				type: 1,
				tempo: 110,
		...
		['promenade', {
			...
			download: {
				flac: Link.googleDrive(`0B-nGL81MTHrcZmdvbm5DU3dsUDQ`),
				mp3: Link.googleDrive(`0B-nGL81MTHrcS3V6V2FleFRndW8`)
			},
			details: {
				type: 0,
				tempo: 128,
		...
		['lockynAqua', {
			...
			download: {
				flac: Link.googleDrive(`0B-nGL81MTHrcWk4yRkpXVVZKOFk`),
				mp3: Link.googleDrive(`0B-nGL81MTHrcc1FpWmtKSFZSR28`)
			},
			details: {
				type: 1,
				tempo: 140,
		...
		['sunshine', {
			...
			download: {
				mp3: Link.googleDrive(`0B-nGL81MTHrcMHZueHJkSEJ0TWs`)
			},
			details: {
				type: 0,
				tempo: 128,
		...
		['seaLights', {
			...
			download: {
				mp3: Link.googleDrive(`0B-nGL81MTHrcSmxtMlJXV2Y3a3c`)
			},
			details: {
				type: 0,
				tempo: 128,
		...
		['home', {
			...
			download: {
				mp3: `http://vk.com/doc73722124_377034480`
			},
		...
		['inspiration', {
			...
			download: {
				mp3: `http://vk.com/doc73722124_360261074`
			},
		...
		['riverJourney', {
			...
			download: {
				mp3: `http://vk.com/doc73722124_327354826`
			},
		...
		['return', {
			...
			download: {
				mp3: `http://vk.com/doc73722124_316157307`
			},
		...
		['timeRift', {
			...
			download: {
				mp3: `http://vk.com/doc73722124_309109592`
			},
		...
		['adventure', {
			...
			download: {
				mp3: `http://vk.com/doc73722124_303679279`
			},
		...
		['waterfall', {
			...
			download: {
				mp3: `http://vk.com/doc73722124_299267375`
			},
		...
		['dream', {
			...
			download: {
				mp3: `http://vk.com/doc73722124_296703772`
			},
	...
	trackList.forEach((track, id) => {
		...
		if (track.links.youtube && track.links.youtube.id) {
			track.links.youtube.href = Link.youtube(track.links.youtube.id);
		}
	});
